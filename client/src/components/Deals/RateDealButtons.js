...
const RateDealButtons = ({
  ...
  const [portion, setPortion] = useState(
    prevRating ? prevRating.portionRating : 2.5,
  );
  ...
  return (
    <>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between" }}>
        <Typography id="value-label" variant="body2">
          My Value Rating
        </Typography>
        <Rating
          name="value"
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between" }}>
        <Typography id="taste-label" variant="body2">
          My Taste Rating
        </Typography>
        <Rating
          name="taste"
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between" }}>
        <Typography id="portion-label" variant="body2">
          My Portion Size Rating
        </Typography>
        <Rating
          name="portion"
          value={portion}
